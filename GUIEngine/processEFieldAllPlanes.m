...
% Load the coil
baseCoil = bemfmm_loadCoil_app(app.strcoil, app.coilCAD);
...
for coilIndex = 1:length(app.matrices)
    ...
    if(~isempty(app.planes))
        ...
        for n = 1:numberOfPlanes
            ...
            disp(['Making observation plane and computing integrals and fields for plane ', num2str(n), ' of ', num2str(numberOfPlanes)]);
            pause(0.2);
    ...
    disp('Generating full model solution')
